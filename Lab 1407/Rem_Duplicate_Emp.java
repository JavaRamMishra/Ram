...
public class Rem_Duplicate_Emp {
	...
	public static void main(String[] args) {
		...
		Rem_Duplicate_Emp e1=new Rem_Duplicate_Emp("Raja","ELEX");
		Rem_Duplicate_Emp e2=new Rem_Duplicate_Emp("Ram","ELEX");
		Rem_Duplicate_Emp e3=new Rem_Duplicate_Emp("Rambo","COMPS");
		Rem_Duplicate_Emp e4=new Rem_Duplicate_Emp("Sanket","MECH");
		Rem_Duplicate_Emp e5=new Rem_Duplicate_Emp("Shyam","ELEX");
