...
public static void main(String[] args) {
	CheckElementofArrayList s1= new CheckElementofArrayList("Ram","ELEX");
	CheckElementofArrayList s2= new CheckElementofArrayList("Shyam","ELEX");
	
	CheckElementofArrayList s3= new CheckElementofArrayList("Ram","ELEX");
	CheckElementofArrayList s4= new CheckElementofArrayList("Shyam","ELEX");
